...
class PlacesService{
  static final _services = new PlacesService();
  static PlacesService get(){
    return _services;
  }
  final String searchUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-17.825167,31.033510&rankby=distance&type=police&key=AIzaSyBp6u3z-XV1eRfuA_-LU5mtJJBwnGI3La4";
