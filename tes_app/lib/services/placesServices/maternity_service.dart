...
class MaternityService{
  static final _services = new MaternityService();
  static MaternityService get(){
    return _services;
  }
  final String searchUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-17.825167,31.033510&rankby=distance&type=doctor&key=AIzaSyBp6u3z-XV1eRfuA_-LU5mtJJBwnGI3La4";
